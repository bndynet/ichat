...
chat.addMessage({
  ...
  timestamp: Date.now(),
  parts: [
    textPart('**`file` parts** — images render inline outside the text bubble; other MIME types become lightweight download links.'),
    {
      id: 'file-img-url',
      type: 'file',
      mediaType: 'image/png',
...
chat.addMessage({
  ...
  parts: [
    ...
    },
    {
      ...
      snippet: 'Web Components is a suite of technologies allowing the creation of reusable custom elements.',
    },
    {
      id: 'src-no-title',
      type: 'source',
