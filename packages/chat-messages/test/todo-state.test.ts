...
test("isTerminalTodoItem: done is terminal", () => {
  assert.equal(
    isTerminalTodoItem({ id: "a", title: "x", status: "done" }),
    true,
  );
});
...
test("isTerminalTodoItem: skipped is terminal", () => {
  assert.equal(
    isTerminalTodoItem({ id: "a", title: "x", status: "skipped" }),
    true,
  );
});
...
test("isTerminalTodoItem: pending is not terminal", () => {
  assert.equal(
    isTerminalTodoItem({ id: "a", title: "x", status: "pending" }),
    false,
  );
});
...
test("isTerminalTodoItem: active is not terminal", () => {
  assert.equal(
    isTerminalTodoItem({ id: "a", title: "x", status: "active" }),
    false,
  );
});
...
test("isTerminalTodoItem: error is not terminal", () => {
  assert.equal(
    isTerminalTodoItem({ id: "a", title: "x", status: "error" }),
    false,
  );
});
