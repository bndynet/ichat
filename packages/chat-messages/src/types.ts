...
export interface ChatConfig {
   ...
   * - `'auto'` (default): automatically enable when messages exceed 500.
   *
   * When enabled, off-screen message elements are removed from the DOM
